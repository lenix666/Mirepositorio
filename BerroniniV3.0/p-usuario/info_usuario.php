   ...
   <hgroup>
    ...
    <form class="foto_p">
        ...
        <h2>Foto Perfil </h2> 
          ...
          <img src="./recursos/img/usuario/<?php echo $foto_u?>">          
                
     </form>
    <div id="cambiar">
    <form action="./p-usuario/actualiza_foto.php" method="post" enctype="multipart/form-data">
                    <input type="file" name="file">
                    <input type="submit" value="Actualizar" id="cambia_foto" >
                </form>
        </div>
        <br><br><br>
