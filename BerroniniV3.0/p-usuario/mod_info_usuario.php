...
<div id="formulario">
  ...
  <?php                      
   ...
   <hgroup>
    ...
    <form action="./p-usuario/modificar_datos.php" method="post" enctype="multipart/form-data">
             ...
             <input type="text" name="nombre" value="<?php echo $nombre_u ?>"  required >
                 ...
                 <input type="tel" name="telefono" value="<?php echo $telefono_u ?>"  min=0 required>   
                 <label for="correo">E-mail:</label> 
                 <input type="email" name="correo" value="<?php echo  $correo_u ?>" required>						 						
                 <input type="submit" value="Cambiar datos" id="btnsubmit" >
    </form><br>
    <form action="./p-usuario/cambiar_contra.php" method="post" enctype="multipart/form-data">
                ...
                <label for="password2">Nueva Contraseña:</label>
                 <input type="password" name="password2" placeholder="Repita su nueva contraseña" >                                                                                              
                 <br>
